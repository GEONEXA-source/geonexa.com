...
async function init(){
  ...
  subscribed = !!(profile.is_subscribed && notExpired && PLAN_CONFIG[plan]);
  planLevel = subscribed ? plan : null;
  ...
  document.getElementById("planBadge").textContent = `✓ ${PLAN_CONFIG[plan].label} plan — AI Assistant access`;
